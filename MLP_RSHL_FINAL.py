...
training_confusion = confusion_matrix(t, Y_out)
(training_overall_accuracy, training_average_accuracy, training_geometric_mean_accuracy) = accuracy(training_confusion)
...
testing_confusion = confusion_matrix(t, Y_out)
(testing_overall_accuracy, testing_average_accuracy, testing_geometric_mean_accuracy) = accuracy(testing_confusion)

print str(training_overall_accuracy) + ',' + str(training_average_accuracy) + ',' + str(training_geometric_mean_accuracy) + ',' + str(testing_overall_accuracy) + ',' + str(testing_average_accuracy) + ',' + str(testing_geometric_mean_accuracy)
